...
get_header(); ?> <div class="banner-home"> <?php if( have_rows('slides') ): ?> <div class="d-block w-100"><div class="carrossell-banner"> <?php while( have_rows('slides') ): the_row(); 

        $image = get_sub_field('foto_do_fundo');

        ?> <div class="item"><div class="slide-home" style="background-image:url(<?= $image ?>)"></div></div> <?php endwhile; ?> </div></div> <?php endif; ?> </div><section class="depoimentos"><div class="container"><h2>depoimentos de clientes</h2> <?php
