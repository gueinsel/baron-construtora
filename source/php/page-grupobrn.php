...
<section class="secao-padrao bg-white secao-sede">
    <div class="container mt-4">
        
        <div class="cabecalho-secao mb-5">
            <h6 class="subtitulo">Excelência que constrói confiança</h6>
            <h2 class="titulo">Grupo BRN: Solidez, Inovação e Compromisso</h2>
        </div>
            ...
            <div class="col-lg-5">
                <div class="box-azul-sobreposto shadow-lg">
                    <p class="texto-descritivo">
                        A Construtora BRN integra o Grupo BRN, que há mais de 25 anos contribui para o desenvolvimento socioeconômico do país. Com tradição, solidez e credibilidade, atua na construção de condomínios verticais, horizontais e bairros planejados, sempre unindo inovação e responsabilidade para transformar empreendimentos em verdadeiras moradias.
                    </p>
...
<section class="secao-padrao bg-cinza secao-historia">
    <div class="container py-4">
        
        <h6 class="subtitulo mb-4">Uma história de sucesso</h6>
        ...
        <div class="row align-items-center gx-5">
            ...
            <div class="col-lg-7">
                <h3 class="titulo-destaque mb-4">
                    Mais de 15 anos construindo lares onde histórias únicas ganham vida, memórias são criadas e sonhos se transformam em realidade.
                </h3>
                <p class="texto-corrido">
                    Especializado em condomínios e loteamentos, o Grupo BRN une planejamento estratégico, excelência em engenharia e inovação constante para criar empreendimentos que valorizam cidades e transformam a vida das pessoas. Sua atuação vai além da construção, incorporando soluções inteligentes, sustentabilidade e atenção aos detalhes em cada etapa do projeto à entrega.
                </p>
            </div>
        </div>
    </div>
...
<section class="secao-padrao bg-white secao-numeros">
    <div class="container py-4">
        
        <div class="text-center mb-5 mx-auto box-intro-numeros">
            <h3 class="titulo-centralizado mb-3">Entre as maiores construtoras do Brasil</h3>
            <p class="texto-intro">
                Temos orgulho de ser uma força positiva em mais de 47 cidades do estado de São Paulo ao ajudar famílias a conquistarem o sonho da casa própria através do nosso grande compromisso com a comunidade e com práticas sustentáveis.
            </p>
        </div>
...
<section class="secao-padrao bg-white pb-5 secao-logos">
    <div class="container pb-4">
        <div class="row g-4">
            
            <div class="col-lg-6">
                <div class="box-cinza h-100">
